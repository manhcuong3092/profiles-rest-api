...
class HelloApiView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            name = serializer.validated_data.get('name')    #property of HelloSerializer
...
class UserProfileViewSet(viewsets.ModelViewSet):
    ...
    queryset = models.UserProfile.objects.all()     #basename
...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = (permissions.UpdateOwnStatus, IsAuthenticated) #limited  |||  IsAuthenticatedOrReadOnly
